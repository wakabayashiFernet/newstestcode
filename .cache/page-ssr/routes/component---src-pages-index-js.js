...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _public_page_data_sq_d_4202924991_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../public/page-data/sq/d/4202924991.json */ "./public/page-data/sq/d/4202924991.json");
...
const SEO = ({
  ...
  const {
    site
  } = _public_page_data_sq_d_4202924991_json__WEBPACK_IMPORTED_MODULE_0__.data;
  const {
    defaultTitle,
    titleTemplate,
    defaultDescription,
...
const IndexPage = ({
  ...
  title: "Home"
}), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", null, data.allMicrocmsNews.edges.map(({
  node
...
/***/ "./public/page-data/sq/d/4202924991.json":
/*!***********************************************!*\
  !*** ./public/page-data/sq/d/4202924991.json ***!
  \***********************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"data":{"site":{"siteMetadata":{"defaultTitle":"Severus Snape","titleTemplate":"%s · The Real Hero","defaultDescription":"Hogwarts Potions master, Head of Slytherin house and former Death Eater.","siteUrl":"https://www.doe.com","defaultImage":"/snape.jpg","twitterUsername":"@occlumency"}}}}');
